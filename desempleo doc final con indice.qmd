...
Para referencia, uno de los informes del BCE puede descargarse en el siguiente enlace: [Informe BCE – Cifras Económicas, octubre 2025](https://contenido.bce.fin.ec/documentos/Estadisticas/SectorReal/Previsiones/IndCoyuntura/CifrasEconomicas/cie202510.pdf)

El código utilizado para la elaboración de este reporte y el análisis de los datos se encuentra disponible en GitHub: [Repositorio Tasa de desempleo](https://github.com/josevrz/Tasa-de-desempleo)
